;; 1. Based on: Simulation_9.1
;; 2. Description: M_DEP_Neb_at_Humidifier Dry End
;; x1. Author: user
...
; Bend2
EI_BEND2 = (8 * SIN(THETA2_INSP) * F1_BEND1_INSP) / (RR0 * F0_BEND1_INSP) * ST0_INSP   
...
NOPRINT ONEHEADER FILE=VMN_Pos3-1.tab
